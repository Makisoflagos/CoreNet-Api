...
function resetMail(link, UserName) {
    return `
...
<body>
  <div class="container">
    ...
    <div class="verification-message">Kindly reset your password with the link sent to you. Thank you for using CoreNet:</div>
    <a href=${link} class="verification-button">Reset Password</a>
  </div>
  <div class="footer">
