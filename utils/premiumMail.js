function premiumMail( UserName) {
    ...
    <body>
      <div class="container">
        ...
        <div class="verification-message">Thank you for upgrading to the premium version of CoreNet. 
        You have been upgraded to a package that comes with unlimited employee signup. 
        CoreNet is dedicated to providing you with the best in terms of work and tracking.</div>
      </div>
      <div class="footer">
